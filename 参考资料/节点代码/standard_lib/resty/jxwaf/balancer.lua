...
if balance_host and balance_host[scheme] == "true" then
    ...
    local ip_lists = balance_host["waf_update_source_ip"]
    local source_http_port = balance_host["source_http_port"]
    local source_https_port = balance_host["source_https_port"]
