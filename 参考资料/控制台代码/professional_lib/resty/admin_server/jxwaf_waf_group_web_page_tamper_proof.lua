...
function _M.get_group_web_page_tamper_proof_list()
...
local count_sql = "SELECT COUNT(*) AS total FROM jxwaf_waf_group_web_page_tamper_proof WHERE `user_name` = ? AND `group_name` = ? ;"
  ...
  local sql = "SELECT * FROM jxwaf_waf_group_web_page_tamper_proof  WHERE `user_name` = ? AND `group_name` = ? ORDER BY rule_order_time ASC LIMIT ? OFFSET ?;"
...
function _M.get_group_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"group_name","rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local group_name = body_data['group_name']
  local rule_name = body_data['rule_name']
  local sql = "SELECT * FROM jxwaf_waf_group_web_page_tamper_proof  WHERE `user_name` = ? AND `group_name` = ? AND `rule_name` = ?;"
...
function _M.create_group_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"group_name","rule_name","rule_detail","rule_matchs","cache_page_url","cache_page_content","cache_content_type"}
  local body_data = request_data.get_body_data(check_param)
  local group_name = body_data['group_name']
  local rule_name = body_data['rule_name']
  local rule_detail = body_data['rule_detail']
  local rule_matchs = body_data['rule_matchs']
  local cache_page_url = body_data['cache_page_url']
  local cache_page_content = body_data['cache_page_content']
  local cache_content_type = body_data['cache_content_type']
  local count_sql = "SELECT COUNT(*) as count FROM jxwaf_waf_group_web_page_tamper_proof WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
  ...
  local create_sql = "INSERT INTO jxwaf_waf_group_web_page_tamper_proof (user_name,group_name, rule_name, rule_detail,rule_matchs,cache_page_url,cache_page_content,rule_order_time,cache_content_type) VALUES (?,?,?,?,?,?,?,?,?);"
  local create_sql_params = {user_name,group_name,rule_name,rule_detail,rule_matchs,cache_page_url,cache_page_content,rule_order_time,cache_content_type}
...
function _M.delete_group_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"group_name","rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local group_name = body_data['group_name']
  local rule_name = body_data['rule_name']
  local sql = "DELETE FROM jxwaf_waf_group_web_page_tamper_proof WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
...
function _M.edit_group_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"group_name","rule_name","rule_detail","rule_matchs","cache_page_url","cache_page_content","cache_content_type"}
  local body_data = request_data.get_body_data(check_param)
  local group_name = body_data['group_name']
  ...
  local cache_page_content = body_data['cache_page_content']
  local cache_content_type = body_data['cache_content_type']
  local sql = "UPDATE jxwaf_waf_group_web_page_tamper_proof  SET rule_detail = ?,rule_matchs = ?,cache_page_url = ?,cache_page_content = ?,cache_content_type=? WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
  local sql_params = {rule_detail,rule_matchs,cache_page_url,cache_page_content,cache_content_type,group_name,user_name,rule_name}
  local sql_result,sql_error = db_query.query_mysql(sql,sql_params)
  if not sql_result then
    response.fail_response(sql_error)
  end
...
function _M.edit_group_web_page_tamper_proof_status()
  local user_name = login_check.get_session()
  ...
  local sql = "UPDATE jxwaf_waf_group_web_page_tamper_proof  SET  status = ? WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
...
function _M.exchange_group_web_page_tamper_proof_priority()
  local user_name = login_check.get_session()
  ...
  if exchange_type == "top" then
    local sql = "SELECT rule_order_time FROM jxwaf_waf_group_web_page_tamper_proof  WHERE `user_name` = ? AND `group_name` = ? ORDER BY `rule_order_time` ASC limit 1;"
    ...
    local exchange_sql = "UPDATE jxwaf_waf_group_web_page_tamper_proof  SET  rule_order_time = ? WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
  ...
  elseif exchange_type == "exchange" then
    ...
    local rule_query_sql = "SELECT rule_order_time FROM jxwaf_waf_group_web_page_tamper_proof  WHERE `user_name` = ? AND `group_name` = ? AND `rule_name` = ?;"
    ...
    local exchange_query_sql = "SELECT rule_order_time FROM jxwaf_waf_group_web_page_tamper_proof  WHERE `user_name` = ? AND `group_name` = ? AND `rule_name` = ?;"
    ...
    local rule_update_sql = "UPDATE jxwaf_waf_group_web_page_tamper_proof  SET  rule_order_time = ? WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
    ...
    local exchange_update_sql = "UPDATE jxwaf_waf_group_web_page_tamper_proof  SET  rule_order_time = ? WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
...
function _M.backup_group_web_page_tamper_proof()
  local user_name = login_check.get_session()
  ...
  ngx.status = 200
  ngx.header.content_type = 'application/json'
  ngx.header['Content-Disposition'] = 'attachment; filename="web_page_tamper_proof_data.json"'
  ngx.say(cjson.encode(rules))
  return ngx.exit(200)
end

function _M.load_group_web_page_tamper_proof()
  local user_name = login_check.get_session()
  ...
  for _,rule in ipairs(rules) do 
    ...
    local cache_page_url = rule['cache_page_url']
    local cache_page_content = rule['cache_page_content']
    local cache_content_type = rule['cache_content_type']
    local count_sql = "SELECT COUNT(*) as count FROM jxwaf_waf_group_web_page_tamper_proof WHERE group_name = ? AND user_name = ? AND rule_name = ?;"
    local count_sql_params = {group_name,user_name,rule_name}
    local count_sql_result,count_error = db_query.query_mysql(count_sql,count_sql_params)
    if not count_sql_result then
...
local function load_web_page_tamper_proof_data(user_name,group_name,web_page_tamper_proof_data)
    for k,v in pairs(web_page_tamper_proof_data) do
        local rule_name = v['rule_name']
        local rule_detail = v['rule_detail']
        local rule_matchs = v['rule_matchs']
        local cache_page_url = v['cache_page_url']
        local cache_page_content = v['cache_page_content']
        local cache_content_type = v['cache_content_type']
        local status = v['status']
        local rule_order_time = v['rule_order_time']
        local sql = "DELETE FROM jxwaf_waf_group_web_page_tamper_proof WHERE user_name = ? AND group_name = ? AND rule_name = ? ;"
        local sql_params = {user_name,group_name,rule_name}
        local sql_result,sql_error = db_query.query_mysql(sql,sql_params)
        if not sql_result then
          response.fail_response(sql_error)
        end
        local create_sql = "INSERT INTO jxwaf_waf_group_web_page_tamper_proof (user_name,group_name, rule_name, rule_detail,rule_matchs,cache_page_url,cache_page_content,rule_order_time,status,cache_content_type) VALUES (?,?,?,?,?,?,?,?,?,?);"
        local create_sql_params = {user_name,group_name,rule_name,rule_detail,rule_matchs,cache_page_url,cache_page_content,rule_order_time,status,cache_content_type}
        local create_result,create_err = db_query.query_mysql(create_sql,create_sql_params)
        if not create_result then
          response.fail_response(create_err)
        end
...
function _M.load_group_web_page_tamper_proof_hub_config()
    local user_name = login_check.get_session()
    ...
    local web_page_tamper_proof_data = res_body['web_page_tamper_proof_data']
    if not web_page_tamper_proof_data then
        if auth_code and #auth_code ~= 0 then
            response.fail_response("auth_code is error")
        else
            response.fail_response("web_page_tamper_proof_data is nil")
        end
    end
    if force_load == "false" then
        for k, v in pairs(web_page_tamper_proof_data) do
            local sql = "SELECT COUNT(*) as count FROM jxwaf_waf_group_web_page_tamper_proof WHERE user_name = ? AND group_name = ?  AND rule_name = ?;"
    ...
    load_web_page_tamper_proof_data(user_name,group_name,web_page_tamper_proof_data)
    response.success_response("load success")
end

function _M.export_group_web_page_tamper_proof_hub_config()
  local user_name = login_check.get_session()
  local check_param = {"web_page_tamper_proof","group_name"}
  local body_data = request_data.get_body_data(check_param)
  local web_page_tamper_proof = body_data['web_page_tamper_proof']
  local group_name = body_data['group_name']
  local web_page_tamper_proof_data = {}
  for _,rule_name in ipairs(web_page_tamper_proof) do
      local sql = "SELECT * FROM jxwaf_waf_group_web_page_tamper_proof  WHERE `user_name` = ? AND `group_name` = ? AND `rule_name` = ?;"
      local sql_params = {user_name,group_name,rule_name}
      ...
      web_page_tamper_proof_data[rule_name] = {
        rule_name = result[1]['rule_name'],
        rule_detail = result[1]['rule_detail'],
        rule_matchs = result[1]['rule_matchs'],
        cache_page_url = result[1]['cache_page_url'],
        cache_page_content = result[1]['cache_page_content'],
        cache_content_type = result[1]['cache_content_type'],
    ...
    cjson.encode_empty_table_as_object(false)
    local response_message = {
        web_page_tamper_proof_data = web_page_tamper_proof_data,
        result = true
    }
    response.raw_success_response(response_message)
end

function _M.waf_get_cache_page_url()
  local user_name = login_check.get_session()
  local check_param = {"cache_page_url"}
  local body_data = request_data.get_body_data(check_param)
  local cache_page_url = body_data['cache_page_url']
  local result,cache_page_content,cache_content_type = tools.waf_get_cache_page_url(cache_page_url)
  if result then
      local response_message = {
     ...
     response.fail_response(cache_page_content)
  end
end
