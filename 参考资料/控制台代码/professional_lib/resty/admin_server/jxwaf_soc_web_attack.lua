...
function _M.get_soc_web_attack_count_total()
  ...
  if not group_name and not domain then
    sql = [=[
      ...
      waf_module IN ('web_engine_protection', 'web_rule_protection')
    ]=]   -- 移除 ;
  elseif group_name and not domain then
    sql = [=[
      ...
      FROM ]=] .. report_conf_ch_table .. [=[
      WHERE request_time BETWEEN toDateTime(?) AND toDateTime(?) AND
      waf_module IN ('web_engine_protection', 'web_rule_protection') AND
      group_name = ?
    ]=]
...
function _M.get_soc_web_attack_api_count_total()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
...
function _M.get_soc_web_attack_ip_count_total()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
...
function _M.get_soc_web_attack_isocode_count_total()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
...
function _M.get_soc_web_attack_geoip()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
  ...
  if not group_name and not domain then
    sql = [=[
      ...
      FROM ]=] .. report_conf_ch_table .. [=[
      WHERE request_time BETWEEN toDateTime(?) AND toDateTime(?) AND
      waf_module IN ('web_engine_protection', 'web_rule_protection') AND notEmpty(iso_code)
  ...
  elseif group_name and domain then
    ...
    sql = [=[
      ...
      FROM ]=] .. report_conf_ch_table .. [=[
      WHERE request_time BETWEEN toDateTime(?) AND toDateTime(?) AND
      waf_module IN ('web_engine_protection', 'web_rule_protection') AND notEmpty(iso_code)  AND
...
function _M.get_soc_web_attack_count_trend()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
  ...
  if group_name then
    ...
    sql = "SELECT " .. group_by_func .. " AS TimeSlot, COUNT(*) AS AttackCount " ..
          "FROM " .. report_conf_ch_table .. " " ..
          "WHERE request_time BETWEEN toDateTime(?) AND toDateTime(?) AND " ..
          "waf_module IN ('web_engine_protection', 'web_rule_protection') " .. domain_condition ..
          "GROUP BY TimeSlot " ..
          "ORDER BY TimeSlot"
  end
...
function _M.get_soc_web_attack_api_top()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
...
function _M.get_soc_web_attack_type_top()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
...
function _M.get_soc_web_attack_ip_top()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
...
function _M.get_soc_web_attack_isocode_top()
  local user_name = login_check.get_session()
  local check_param = {"from_time","to_time"}
  local body_data = request_data.get_body_data(check_param)
  local from_time = body_data['from_time']
