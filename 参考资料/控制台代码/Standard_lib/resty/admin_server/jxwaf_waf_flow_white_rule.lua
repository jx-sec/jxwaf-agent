...
function _M.get_flow_white_rule_list()
  ...
  local count_sql = "SELECT COUNT(*) AS total FROM jxwaf_waf_flow_white_rule WHERE `user_name` = ?;"
  ...
  local sql = "SELECT * FROM jxwaf_waf_flow_white_rule WHERE `user_name` = ? ORDER BY rule_order_time ASC LIMIT ? OFFSET ?;"
...
function _M.get_flow_white_rule()
  local user_name = login_check.get_session()
  local check_param = {"rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local sql = "SELECT * FROM jxwaf_waf_flow_white_rule WHERE `user_name` = ? AND `rule_name` = ?;"
...
function _M.create_flow_white_rule()
  local user_name = login_check.get_session()
  ...
  local count_sql = "SELECT COUNT(*) as count FROM jxwaf_waf_flow_white_rule WHERE user_name = ? AND rule_name = ?;"
  ...
  local create_sql = "INSERT INTO jxwaf_waf_flow_white_rule (user_name, rule_name, rule_detail, rule_matchs, rule_action, action_value, rule_order_time) VALUES (?,?,?,?,?,?,?);"
...
function _M.delete_flow_white_rule()
  local user_name = login_check.get_session()
  local check_param = {"rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local sql = "DELETE FROM jxwaf_waf_flow_white_rule WHERE user_name = ? AND rule_name = ?;"
  local sql_params = {user_name, rule_name}
...
function _M.edit_flow_white_rule()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","rule_detail","rule_matchs","rule_action","action_value"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  ...
  local rule_action = body_data['rule_action']
  local action_value = body_data['action_value']
  local sql = "UPDATE jxwaf_waf_flow_white_rule SET rule_detail = ?, rule_matchs = ?, rule_action = ?, action_value = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.edit_flow_white_rule_status()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","status"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local status = body_data['status']
  local sql = "UPDATE jxwaf_waf_flow_white_rule SET status = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.exchange_flow_white_rule_priority()
  local user_name = login_check.get_session()
  ...
  if exchange_type == "top" then
    local sql = "SELECT rule_order_time FROM jxwaf_waf_flow_white_rule WHERE `user_name` = ? ORDER BY `rule_order_time` ASC limit 1;"
    ...
    local exchange_sql = "UPDATE jxwaf_waf_flow_white_rule SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
  ...
  elseif exchange_type == "exchange" then
    ...
    local rule_query_sql = "SELECT rule_order_time FROM jxwaf_waf_flow_white_rule WHERE `user_name` = ? AND `rule_name` = ?;"
    ...
    local exchange_query_sql = "SELECT rule_order_time FROM jxwaf_waf_flow_white_rule WHERE `user_name` = ? AND `rule_name` = ?;"
    ...
    local rule_update_sql = "UPDATE jxwaf_waf_flow_white_rule SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
    ...
    local exchange_update_sql = "UPDATE jxwaf_waf_flow_white_rule SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.backup_flow_white_rule()
  local user_name = login_check.get_session()
...
function _M.load_flow_white_rule()
  local user_name = login_check.get_session()
...
local function load_flow_white_rule_data(user_name, flow_white_rule_data)
    for k, v in pairs(flow_white_rule_data) do
        ...
        local create_sql = "INSERT INTO jxwaf_waf_flow_white_rule (user_name, rule_name, rule_detail, rule_matchs, rule_action, action_value, rule_order_time, status) VALUES (?,?,?,?,?,?,?,?);"
...
function _M.load_flow_white_rule_hub_config()
    local user_name = login_check.get_session()
    ...
    if force_load == "false" then
        for k, v in pairs(flow_white_rule_data) do
            local sql = "SELECT COUNT(*) as count FROM jxwaf_waf_flow_white_rule WHERE user_name = ? AND rule_name = ?;"
    ...
    load_flow_white_rule_data(user_name, flow_white_rule_data)
    response.success_response("load success")
end

function _M.export_flow_white_rule_hub_config()
  local user_name = login_check.get_session()
  local check_param = {"flow_white_rule"}
  local body_data = request_data.get_body_data(check_param)
