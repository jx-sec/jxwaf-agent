...
function _M.get_web_page_tamper_proof_list()
  ...
  local count_sql = "SELECT COUNT(*) AS total FROM jxwaf_waf_web_page_tamper_proof WHERE `user_name` = ?;"
  ...
  local sql = "SELECT * FROM jxwaf_waf_web_page_tamper_proof WHERE `user_name` = ? ORDER BY rule_order_time ASC LIMIT ? OFFSET ?;"
...
function _M.get_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local sql = "SELECT * FROM jxwaf_waf_web_page_tamper_proof WHERE `user_name` = ? AND `rule_name` = ?;"
...
function _M.create_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","rule_detail","rule_matchs","cache_page_url","cache_page_content","cache_content_type"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  ...
  local count_sql = "SELECT COUNT(*) as count FROM jxwaf_waf_web_page_tamper_proof WHERE user_name = ? AND rule_name = ?;"
  ...
  local create_sql = "INSERT INTO jxwaf_waf_web_page_tamper_proof (user_name, rule_name, rule_detail, rule_matchs, cache_page_url, cache_page_content, rule_order_time, cache_content_type) VALUES (?,?,?,?,?,?,?,?);"
  local create_sql_params = {user_name, rule_name, rule_detail, rule_matchs, cache_page_url, cache_page_content, rule_order_time, cache_content_type}
...
function _M.delete_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local sql = "DELETE FROM jxwaf_waf_web_page_tamper_proof WHERE user_name = ? AND rule_name = ?;"
  local sql_params = {user_name, rule_name}
...
function _M.edit_web_page_tamper_proof()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","rule_detail","rule_matchs","cache_page_url","cache_page_content","cache_content_type"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  ...
  local cache_page_content = body_data['cache_page_content']
  local cache_content_type = body_data['cache_content_type']
  local sql = "UPDATE jxwaf_waf_web_page_tamper_proof SET rule_detail = ?, rule_matchs = ?, cache_page_url = ?, cache_page_content = ?, cache_content_type = ? WHERE user_name = ? AND rule_name = ?;"
  local sql_params = {rule_detail, rule_matchs, cache_page_url, cache_page_content, cache_content_type, user_name, rule_name}
  local sql_result,sql_error = db_query.query_mysql(sql,sql_params)
  if not sql_result then
    response.fail_response(sql_error)
  end
...
function _M.edit_web_page_tamper_proof_status()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","status"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local status = body_data['status']
  local sql = "UPDATE jxwaf_waf_web_page_tamper_proof SET status = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.exchange_web_page_tamper_proof_priority()
  local user_name = login_check.get_session()
  ...
  if exchange_type == "top" then
    local sql = "SELECT rule_order_time FROM jxwaf_waf_web_page_tamper_proof WHERE `user_name` = ? ORDER BY `rule_order_time` ASC limit 1;"
    ...
    local exchange_sql = "UPDATE jxwaf_waf_web_page_tamper_proof SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
  ...
  elseif exchange_type == "exchange" then
    ...
    local rule_query_sql = "SELECT rule_order_time FROM jxwaf_waf_web_page_tamper_proof WHERE `user_name` = ? AND `rule_name` = ?;"
    ...
    local exchange_query_sql = "SELECT rule_order_time FROM jxwaf_waf_web_page_tamper_proof WHERE `user_name` = ? AND `rule_name` = ?;"
    ...
    local rule_update_sql = "UPDATE jxwaf_waf_web_page_tamper_proof SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
    ...
    local exchange_update_sql = "UPDATE jxwaf_waf_web_page_tamper_proof SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.backup_web_page_tamper_proof()
  local user_name = login_check.get_session()
...
function _M.load_web_page_tamper_proof()
  local user_name = login_check.get_session()
...
local function load_web_page_tamper_proof_data(user_name, web_page_tamper_proof_data)
    for k,v in pairs(web_page_tamper_proof_data) do
        ...
        local create_sql = "INSERT INTO jxwaf_waf_web_page_tamper_proof (user_name, rule_name, rule_detail, rule_matchs, cache_page_url, cache_page_content, rule_order_time, status, cache_content_type) VALUES (?,?,?,?,?,?,?,?,?);"
        local create_sql_params = {user_name, rule_name, rule_detail, rule_matchs, cache_page_url, cache_page_content, rule_order_time, status, cache_content_type}
        local create_result, create_err = db_query.query_mysql(create_sql, create_sql_params)
        if not create_result then
          response.fail_response(create_err)
        end
...
function _M.load_web_page_tamper_proof_hub_config()
    local user_name = login_check.get_session()
    ...
    if force_load == "false" then
        for k, v in pairs(web_page_tamper_proof_data) do
            local sql = "SELECT COUNT(*) as count FROM jxwaf_waf_web_page_tamper_proof WHERE user_name = ? AND rule_name = ?;"
    ...
    load_web_page_tamper_proof_data(user_name, web_page_tamper_proof_data)
    response.success_response("load success")
end

function _M.export_web_page_tamper_proof_hub_config()
  local user_name = login_check.get_session()
  local check_param = {"web_page_tamper_proof"}
  local body_data = request_data.get_body_data(check_param)
