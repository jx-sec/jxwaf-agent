...
function _M.get_web_rule_protection_list()
  ...
  local count_sql = "SELECT COUNT(*) AS total FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ?;"
  ...
  local sql = "SELECT * FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ? ORDER BY rule_order_time ASC LIMIT ? OFFSET ?;"
...
function _M.api_get_web_rule_protection_list()
  local user_name = login_check.get_session()
  local sql = "SELECT * FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ?;"
...
function _M.get_web_rule_protection()
  local user_name = login_check.get_session()
  local check_param = {"rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local sql = "SELECT * FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ? AND `rule_name` = ?;"
...
function _M.create_web_rule_protection()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","rule_detail","rule_matchs","rule_action","action_value"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  ...
  local count_sql = "SELECT COUNT(*) as count FROM jxwaf_waf_web_rule_protection WHERE user_name = ? AND rule_name = ?;"
  ...
  local create_sql = "INSERT INTO jxwaf_waf_web_rule_protection (user_name, rule_name, rule_detail, rule_matchs, rule_action, action_value, rule_order_time) VALUES (?,?,?,?,?,?,?);"
  local create_sql_params = {user_name, rule_name, rule_detail, rule_matchs, rule_action, action_value, rule_order_time}
...
function _M.delete_web_rule_protection()
  local user_name = login_check.get_session()
  local check_param = {"rule_name"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  local sql = "DELETE FROM jxwaf_waf_web_rule_protection WHERE user_name = ? AND rule_name = ?;"
  local sql_params = {user_name, rule_name}
...
function _M.edit_web_rule_protection()
  local user_name = login_check.get_session()
  local check_param = {"rule_name","rule_detail","rule_matchs","rule_action","action_value"}
  local body_data = request_data.get_body_data(check_param)
  local rule_name = body_data['rule_name']
  ...
  local sql = "UPDATE jxwaf_waf_web_rule_protection SET rule_detail = ?, rule_matchs = ?, rule_action = ?, action_value = ? WHERE user_name = ? AND rule_name = ?;"
  local sql_params = {rule_detail, rule_matchs, rule_action, action_value, user_name, rule_name}
  local sql_result,sql_error = db_query.query_mysql(sql,sql_params)
  if not sql_result then
    response.fail_response(sql_error)
  end
...
function _M.edit_web_rule_protection_status()
  local user_name = login_check.get_session()
  ...
  local sql = "UPDATE jxwaf_waf_web_rule_protection SET status = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.exchange_web_rule_protection_priority()
  local user_name = login_check.get_session()
  ...
  if exchange_type == "top" then
    local sql = "SELECT rule_order_time FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ? ORDER BY `rule_order_time` ASC limit 1;"
    local sql_params = {user_name}
    local query_result = db_query.query_mysql(sql,sql_params)
    ...
    local exchange_sql = "UPDATE jxwaf_waf_web_rule_protection SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
  ...
  elseif exchange_type == "exchange" then
    ...
    local rule_query_sql = "SELECT rule_order_time FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ? AND `rule_name` = ?;"
    ...
    local exchange_query_sql = "SELECT rule_order_time FROM jxwaf_waf_web_rule_protection WHERE `user_name` = ? AND `rule_name` = ?;"
    ...
    local rule_update_sql = "UPDATE jxwaf_waf_web_rule_protection SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
    ...
    local exchange_update_sql = "UPDATE jxwaf_waf_web_rule_protection SET rule_order_time = ? WHERE user_name = ? AND rule_name = ?;"
...
function _M.backup_web_rule_protection()
  local user_name = login_check.get_session()
...
function _M.load_web_rule_protection()
  local user_name = login_check.get_session()
...
local function load_web_rule_protection_data(user_name, web_rule_protection_data)
    for k,v in pairs(web_rule_protection_data) do
        ...
        local create_sql = "INSERT INTO jxwaf_waf_web_rule_protection (user_name, rule_name, rule_detail, rule_matchs, rule_action, action_value, rule_order_time, status) VALUES (?,?,?,?,?,?,?,?);"
        local create_sql_params = {user_name, rule_name, rule_detail, rule_matchs, rule_action, action_value, rule_order_time, status}
        local create_result, create_err = db_query.query_mysql(create_sql, create_sql_params)
        if not create_result then
          response.fail_response(create_err)
        end
...
function _M.load_web_rule_protection_hub_config()
    local user_name = login_check.get_session()
    ...
    if force_load == "false" then
        for k, v in pairs(web_rule_protection_data) do
            local sql = "SELECT COUNT(*) as count FROM jxwaf_waf_web_rule_protection WHERE user_name = ? AND rule_name = ?;"
    ...
    load_web_rule_protection_data(user_name, web_rule_protection_data)
    response.success_response("load success")
end

function _M.export_web_rule_protection_hub_config()
  local user_name = login_check.get_session()
  local check_param = {"web_rule_protection"}
  local body_data = request_data.get_body_data(check_param)
